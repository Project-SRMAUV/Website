...
const sponsorsData = [
    ...
    { name: 'SRM IST', logoUrl: 'src/assets/Srmist_logo.png', category: 'Academic Partner' },
    { name: 'Blue Robotics', logoUrl: 'src/assets/blue_robotics.png', category: 'Component Supplier' },
    { name: 'Anekonnect', logoUrl: 'src/assets/logo_anekonnect.png', category: 'Funding' },
    { name: 'NVIDIA', logoUrl: 'src/assets/nvidia_logo.jpg', category: 'Tech Partner' },
    { name: 'SRM Innovation and Incubation Centre', logoUrl: 'src/assets/srm_iic.png', category: 'Academic Partner' },
    { name: 'NIOT', logoUrl: 'src/assets/niot_logo.jpg', category: 'Academic Partner' },
];
    ...
    <header className="nav-bar">
      <div className="nav-content">
        ...
        <a href="#home" className="nav-brand-logo-container" onClick={() => setIsOpen(false)}>
            <img src="src/assets/auvlogo.png" alt="SRM AUV Logo" className="nav-brand-logo" /> 
        </a>
        ...
        <section className="image-gallery-section">
            <h3 className="gallery-title">Visual Showcase</h3>
             <div className="image-placeholder main-image-placeholder">
                <img src="src/assets/ZARNA.jpg" alt="ZARNA AUV Main View" className="main-vehicle-image" />
             </div>
             <div className="image-gallery-grid">
                <img src="src/assets/ZARNA1.jpg" alt="ZARNA Electronics Bay" className="gallery-image" />
                <img src="src/assets/ZARNA2.jpg" alt="ZARNA Thruster Array" className="gallery-image" />
             </div>
        </section>
